...
class ExpenseReceiptNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \JoliCode\Harvest\Api\Model\ExpenseReceipt::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\ExpenseReceipt::class === $data::class;
    }
    ...
    {
        return [\JoliCode\Harvest\Api\Model\ExpenseReceipt::class => false];
    }
}
