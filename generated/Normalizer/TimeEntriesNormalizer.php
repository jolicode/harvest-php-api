...
class TimeEntriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\TimeEntries';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\TimeEntries';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'time_entries') && $data->{'time_entries'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'time_entries') && $data->{'time_entries'} === null) {
            $object->setTimeEntries(null);
        }
