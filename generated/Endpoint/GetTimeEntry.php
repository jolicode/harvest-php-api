...
class GetTimeEntry extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     *
     *     @var string $user_id only return time entries belonging to the user with the given ID
     *     @var string $client_id only return time entries belonging to the client with the given ID
     *     @var string $project_id only return time entries belonging to the project with the given ID
     *     @var string $is_billed pass true to only return time entries that have been invoiced and false to return time entries that have not been invoiced
     *     @var string $is_running pass true to only return running time entries and false to return non-running time entries
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setAllowedTypes('is_billed', ['string']);
        $optionsResolver->setAllowedTypes('is_running', ['string']);
