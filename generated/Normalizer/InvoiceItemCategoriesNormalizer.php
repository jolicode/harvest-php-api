...
class InvoiceItemCategoriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'invoice_item_categories') && $data->{'invoice_item_categories'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'invoice_item_categories') && $data->{'invoice_item_categories'} === null) {
            $object->setInvoiceItemCategories(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getInvoiceItemCategories()) {
            ...
            $data->{'invoice_item_categories'} = null;
        }
