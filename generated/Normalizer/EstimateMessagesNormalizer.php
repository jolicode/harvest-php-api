...
class EstimateMessagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\EstimateMessages';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\EstimateMessages';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        elseif (property_exists($data, 'estimate_messages') && $data->{'estimate_messages'} === null) {
