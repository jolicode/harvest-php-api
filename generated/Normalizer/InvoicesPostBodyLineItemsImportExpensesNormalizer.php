...
class InvoicesPostBodyLineItemsImportExpensesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \JoliCode\Harvest\Api\Model\InvoicesPostBodyLineItemsImportExpenses::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\InvoicesPostBodyLineItemsImportExpenses::class === $data::class;
    }
    ...
    {
        return [\JoliCode\Harvest\Api\Model\InvoicesPostBodyLineItemsImportExpenses::class => false];
    }
}
