...
class InvoiceMessageRecipientsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\InvoiceMessageRecipients';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\InvoiceMessageRecipients';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'invoice_message_recipients') && $data->{'invoice_message_recipients'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'invoice_message_recipients') && $data->{'invoice_message_recipients'} === null) {
            $object->setInvoiceMessageRecipients(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getInvoiceMessageRecipients()) {
            ...
            $data->{'invoice_message_recipients'} = null;
        }
