...
class InvoiceItemCategoriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('invoice_item_categories', $data) && $data['invoice_item_categories'] !== null) {
            $values = array();
        ...
        elseif (\array_key_exists('invoice_item_categories', $data) && $data['invoice_item_categories'] === null) {
