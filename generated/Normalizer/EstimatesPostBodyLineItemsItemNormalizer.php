...
class EstimatesPostBodyLineItemsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'time') && $data->{'time'} !== null) {
            $object->setTime($this->denormalizer->denormalize($data->{'time'}, 'JoliCode\\Harvest\\Api\\Model\\EstimatesPostBodyLineItemsItemTime', 'json', $context));
        }
        elseif (property_exists($data, 'time') && $data->{'time'} === null) {
            $object->setTime(null);
        }
        if (property_exists($data, 'expenses') && $data->{'expenses'} !== null) {
            $object->setExpenses($this->denormalizer->denormalize($data->{'expenses'}, 'JoliCode\\Harvest\\Api\\Model\\EstimatesPostBodyLineItemsItemExpenses', 'json', $context));
        }
