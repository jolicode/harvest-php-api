...
class InvoiceMessagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\InvoiceMessages';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\InvoiceMessages';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'invoice_messages') && $data->{'invoice_messages'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'invoice_messages') && $data->{'invoice_messages'} === null) {
            $object->setInvoiceMessages(null);
        }
