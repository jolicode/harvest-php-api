...
class InvoicesPostBodyLineItemsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \JoliCode\Harvest\Api\Model\InvoicesPostBodyLineItemsItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\InvoicesPostBodyLineItemsItem::class === $data::class;
    }
    ...
    {
        return [\JoliCode\Harvest\Api\Model\InvoicesPostBodyLineItemsItem::class => false];
    }
}
