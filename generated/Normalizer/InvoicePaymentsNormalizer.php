...
class InvoicePaymentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Harvest\\Api\\Model\\InvoicePayments' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'JoliCode\\Harvest\\Api\\Model\\InvoicePayments' === $data::class;
    }
    ...
    {
        return ['JoliCode\\Harvest\\Api\\Model\\InvoicePayments' => false];
    }
}
