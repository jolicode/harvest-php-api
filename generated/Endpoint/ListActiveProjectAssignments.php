...
class ListActiveProjectAssignments extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Endpoint
{
    protected $userId;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{userId}'), array($this->userId), '/users/{userId}/project_assignments');
    }
