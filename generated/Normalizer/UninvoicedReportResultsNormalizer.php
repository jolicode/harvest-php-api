...
class UninvoicedReportResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Harvest\\Api\\Model\\UninvoicedReportResults' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'JoliCode\\Harvest\\Api\\Model\\UninvoicedReportResults' === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $class, ?string $format = null, array $context = []):mixed
    {
        ...
        if (\array_key_exists('results', $data)) {
            ...
            foreach ($data['results'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JoliCode\\Harvest\\Api\\Model\\UninvoicedReportResult', 'json', $context);
            }
    ...
    {
        return ['JoliCode\\Harvest\\Api\\Model\\UninvoicedReportResults' => false];
    }
}
