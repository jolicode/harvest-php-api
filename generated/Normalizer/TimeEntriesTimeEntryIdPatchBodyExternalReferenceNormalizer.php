...
class TimeEntriesTimeEntryIdPatchBodyExternalReferenceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBodyExternalReference::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBodyExternalReference::class === $data::class;
    }
    ...
    {
        return [\JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBodyExternalReference::class => false];
    }
}
