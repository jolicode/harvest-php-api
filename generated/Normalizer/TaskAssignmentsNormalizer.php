...
class TaskAssignmentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \JoliCode\Harvest\Api\Model\TaskAssignments;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'taskassignments')) {
            $values = [];
            foreach ($data->{'taskassignments'} as $value) {
