...
class UninvoicedReportResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \JoliCode\Harvest\Api\Model\UninvoicedReportResults::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\UninvoicedReportResults::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \JoliCode\Harvest\Api\Model\UninvoicedReportResults();
        ...
        if (\array_key_exists('results', $data)) {
            ...
            foreach ($data['results'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \JoliCode\Harvest\Api\Model\UninvoicedReportResult::class, 'json', $context);
            }
    ...
    {
        return [\JoliCode\Harvest\Api\Model\UninvoicedReportResults::class => false];
    }
}
