...
class EstimateLineItemsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'estimate_line_items') && $data->{'estimate_line_items'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'estimate_line_items') && $data->{'estimate_line_items'} === null) {
