...
class EstimateItemCategoriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \JoliCode\Harvest\Api\Model\EstimateItemCategories::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\EstimateItemCategories::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('estimate_item_categories', $data)) {
            $values = [];
            foreach ($data['estimate_item_categories'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \JoliCode\Harvest\Api\Model\EstimateItemCategory::class, 'json', $context);
            }
            $object->setEstimateItemCategories($values);
            unset($data['estimate_item_categories']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        $dataArray = [];
        $values = [];
        foreach ($data->getEstimateItemCategories() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['estimate_item_categories'] = $values;
    ...
    {
        return [\JoliCode\Harvest\Api\Model\EstimateItemCategories::class => false];
    }
}
