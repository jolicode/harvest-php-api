...
class InvoicePaymentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'invoice_payments') && $data->{'invoice_payments'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'invoice_payments') && $data->{'invoice_payments'} === null) {
