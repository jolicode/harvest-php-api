...
class UserAssignmentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \JoliCode\Harvest\Api\Model\UserAssignments;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'userassignments')) {
            $values = [];
            foreach ($data->{'userassignments'} as $value) {
