...
class CreateInvoiceItemCategory extends \JoliCode\Harvest\Api\Runtime\Client\BaseEndpoint implements \JoliCode\Harvest\Api\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(\JoliCode\Harvest\Api\Model\InvoiceItemCategoriesPostBody $requestBody)
    {
    ...
    {
        if ($this->body instanceof \JoliCode\Harvest\Api\Model\InvoiceItemCategoriesPostBody) {
