...
class EstimateMessagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \JoliCode\Harvest\Api\Model\EstimateMessages::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\EstimateMessages::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('estimate_messages', $data)) {
            ...
            foreach ($data['estimate_messages'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \JoliCode\Harvest\Api\Model\EstimateMessage::class, 'json', $context);
            }
            $object->setEstimateMessages($values);
            unset($data['estimate_messages']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        $dataArray = [];
        $values = [];
        foreach ($data->getEstimateMessages() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['estimate_messages'] = $values;
    ...
    {
        return [\JoliCode\Harvest\Api\Model\EstimateMessages::class => false];
    }
}
