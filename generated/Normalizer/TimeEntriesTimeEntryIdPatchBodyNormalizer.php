...
class TimeEntriesTimeEntryIdPatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBody::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBody::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('external_reference', $data) && null !== $data['external_reference']) {
            $object->setExternalReference($this->denormalizer->denormalize($data['external_reference'], \JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBodyExternalReference::class, 'json', $context));
    ...
    {
        return [\JoliCode\Harvest\Api\Model\TimeEntriesTimeEntryIdPatchBody::class => false];
    }
}
