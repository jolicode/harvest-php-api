...
class ExpenseCategoriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\ExpenseCategories';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\ExpenseCategories';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('expense_categories', $data) && $data['expense_categories'] !== null) {
            $values = array();
        ...
        elseif (\array_key_exists('expense_categories', $data) && $data['expense_categories'] === null) {
            $object->setExpenseCategories(null);
        }
