...
class InvoiceMessageRecipientsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('invoice_message_recipients', $data) && $data['invoice_message_recipients'] !== null) {
            $values = array();
        ...
        elseif (\array_key_exists('invoice_message_recipients', $data) && $data['invoice_message_recipients'] === null) {
