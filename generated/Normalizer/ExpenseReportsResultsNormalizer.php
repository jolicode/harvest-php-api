...
class ExpenseReportsResultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Harvest\\Api\\Model\\ExpenseReportsResults' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'JoliCode\\Harvest\\Api\\Model\\ExpenseReportsResults' === $data::class;
    }
    ...
    {
        return ['JoliCode\\Harvest\\Api\\Model\\ExpenseReportsResults' => false];
    }
}
