...
class EstimateLineItemsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \JoliCode\Harvest\Api\Model\EstimateLineItems;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'estimatelineitems')) {
            $values = [];
            foreach ($data->{'estimatelineitems'} as $value) {
