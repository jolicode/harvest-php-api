...
class GetEstimate extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     *
     *     @var string $client_id only return estimates belonging to the client with the given ID
