...
class ProjectAssignmentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\ProjectAssignments';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\ProjectAssignments';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'project_assignments') && $data->{'project_assignments'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'project_assignments') && $data->{'project_assignments'} === null) {
            $object->setProjectAssignments(null);
        }
