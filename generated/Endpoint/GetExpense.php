...
class GetExpense extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     *
     *     @var string $user_id only return expenses belonging to the user with the given ID
     *     @var string $client_id only return expenses belonging to the client with the given ID
     *     @var string $project_id only return expenses belonging to the project with the given ID
     *     @var string $is_billed pass true to only return expenses that have been invoiced and false to return expenses that have not been invoiced
