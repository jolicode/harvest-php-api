...
class EstimateMessageRecipientsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\EstimateMessageRecipients';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\EstimateMessageRecipients';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'estimate_message_recipients') && $data->{'estimate_message_recipients'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'estimate_message_recipients') && $data->{'estimate_message_recipients'} === null) {
            $object->setEstimateMessageRecipients(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getEstimateMessageRecipients()) {
            ...
            $data->{'estimate_message_recipients'} = null;
        }
