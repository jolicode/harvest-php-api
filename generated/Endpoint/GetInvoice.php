...
class GetInvoice extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    /**
     ...
     *
     *     @var string $client_id only return invoices belonging to the client with the given ID
     *     @var string $project_id only return invoices associated with the project with the given ID
