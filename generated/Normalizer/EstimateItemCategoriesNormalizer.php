...
class EstimateItemCategoriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\EstimateItemCategories';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'estimate_item_categories') && $data->{'estimate_item_categories'} !== null) {
            $values = array();
        ...
        elseif (property_exists($data, 'estimate_item_categories') && $data->{'estimate_item_categories'} === null) {
            $object->setEstimateItemCategories(null);
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getEstimateItemCategories()) {
            ...
            $data->{'estimate_item_categories'} = null;
        }
