...
class EstimateMessageRecipientsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \JoliCode\Harvest\Api\Model\EstimateMessageRecipients::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\EstimateMessageRecipients::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('estimate_message_recipients', $data)) {
            $values = [];
            ...
            unset($data['estimate_message_recipients']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        $dataArray = [];
        $values = [];
        foreach ($data->getEstimateMessageRecipients() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['estimate_message_recipients'] = $values;
    ...
    {
        return [\JoliCode\Harvest\Api\Model\EstimateMessageRecipients::class => false];
    }
}
