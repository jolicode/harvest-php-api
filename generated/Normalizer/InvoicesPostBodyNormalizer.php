...
class InvoicesPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('lineItemsImport') && null !== $data->getLineItemsImport()) {
            $dataArray['line_items_import'] = $this->normalizer->normalize($data->getLineItemsImport(), 'json', $context);
        }
