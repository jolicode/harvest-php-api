...
class ContactsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Harvest\\Api\\Model\\Contacts';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\Contacts';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \JoliCode\Harvest\Api\Model\Contacts();
        if (property_exists($data, 'contacts') && $data->{'contacts'} !== null) {
            $values = array();
            foreach ($data->{'contacts'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JoliCode\\Harvest\\Api\\Model\\Contact', 'json', $context);
            }
            $object->setContacts($values);
        }
        elseif (property_exists($data, 'contacts') && $data->{'contacts'} === null) {
