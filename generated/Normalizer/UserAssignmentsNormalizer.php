...
class UserAssignmentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Harvest\\Api\\Model\\UserAssignments' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'JoliCode\\Harvest\\Api\\Model\\UserAssignments' === $data::class;
    }
    ...
    {
        return ['JoliCode\\Harvest\\Api\\Model\\UserAssignments' => false];
    }
}
