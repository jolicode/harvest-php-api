...
class ProjectAssignmentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('project_assignments', $data) && $data['project_assignments'] !== null) {
            $values = array();
        ...
        elseif (\array_key_exists('project_assignments', $data) && $data['project_assignments'] === null) {
