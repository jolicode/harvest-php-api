...
class InvoiceMessageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('reminder') && null !== $data->getReminder()) {
            $dataArray['reminder'] = $data->getReminder();
        }
        if ($data->isInitialized('sendReminderOn') && null !== $data->getSendReminderOn()) {
            $dataArray['send_reminder_on'] = $data->getSendReminderOn()->format('Y-m-d');
        }
