...
class CreateUserAssignment extends \JoliCode\Harvest\Api\Runtime\Client\BaseEndpoint implements \JoliCode\Harvest\Api\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $projectId, \JoliCode\Harvest\Api\Model\ProjectsProjectIdUserAssignmentsPostBody $requestBody)
    {
    ...
    {
        if ($this->body instanceof \JoliCode\Harvest\Api\Model\ProjectsProjectIdUserAssignmentsPostBody) {
