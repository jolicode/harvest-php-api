...
class BillableRatesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'JoliCode\\Harvest\\Api\\Model\\BillableRates';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        elseif (property_exists($data, 'billable_rates') && $data->{'billable_rates'} === null) {
            $object->setBillableRates(null);
        }
