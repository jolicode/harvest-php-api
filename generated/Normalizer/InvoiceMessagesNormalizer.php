...
class InvoiceMessagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Harvest\\Api\\Model\\InvoiceMessages' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return \is_object($data) && 'JoliCode\\Harvest\\Api\\Model\\InvoiceMessages' === $data::class;
    }
    ...
    {
        return ['JoliCode\\Harvest\\Api\\Model\\InvoiceMessages' => false];
    }
}
