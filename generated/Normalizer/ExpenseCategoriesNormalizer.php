...
class ExpenseCategoriesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \JoliCode\Harvest\Api\Model\ExpenseCategories::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \JoliCode\Harvest\Api\Model\ExpenseCategories::class === $data::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('expense_categories', $data)) {
            $values = [];
            foreach ($data['expense_categories'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \JoliCode\Harvest\Api\Model\ExpenseCategory::class, 'json', $context);
            }
            $object->setExpenseCategories($values);
            unset($data['expense_categories']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        $dataArray = [];
        $values = [];
        foreach ($data->getExpenseCategories() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['expense_categories'] = $values;
    ...
    {
        return [\JoliCode\Harvest\Api\Model\ExpenseCategories::class => false];
    }
}
